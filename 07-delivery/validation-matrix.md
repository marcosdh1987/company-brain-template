...
|---|---|---|---|
| Meeting transcript | `01-meetings/transcripts/` | `06-decisions/`, `05-requirements/`, `03-projects/`, `07-delivery/` | Promote only after review, via minutes |
...
| Vendor documentation | `09-references/vendor-docs/` | `03-projects/`, `04-architecture/`, `08-vendors/` | Cite the exact document; vendor claims start PENDING VALIDATION |
...
| System observation | `09-references/` or project folder | `03-projects/<p>/current-state.md` | Dated, method stated ("read-only navigation"), a visible screen implies no acceptance |
